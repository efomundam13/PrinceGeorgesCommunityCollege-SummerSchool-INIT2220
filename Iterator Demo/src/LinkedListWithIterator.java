...
//==================================
	...
	private class IteratorForLinkedList implements Iterator<T>
	{
		...
		private Node    priorNode;     // Node containing prior entry in iteration
		...
		public T next()
		{
			if (hasNext())
			{
				...
				priorNode = nodeToRemove;			// Advance iterator
		...
		public void remove()
		{
			...
			{
				if (priorNode != null)
					priorNode.setNextNode(nextNode); // Remove internal node
				else 
				{
					firstNode = nextNode;			   // Remove first node
					nodeToRemove = null;
				} // end else
				...
				throw new IllegalStateException("next not called before " +
