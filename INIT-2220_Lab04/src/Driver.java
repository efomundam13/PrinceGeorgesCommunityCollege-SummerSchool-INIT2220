...
*/
   ...
   public static void answerExercise1InChapter10() {
      ListInterface<String> myList = new AList<>();
      myList.add("A");
      myList.add("B");
      myList.add("C");
      ...
      myList.add(1, "three");
      myList.add(1, "four");
      System.out.println("After executing the statements in Exercise 1 of Chapter 10:");
      displayList(myList);
   } // end answerExercise1InChapter10
      
   public static void answerExercise2InChapter10() {
      ListInterface<String> myList = new AList<>();
      myList.add("alpha");
      myList.add(1, "beta");
      myList.add("gamma");
      ...
      System.out.println("After executing the statements in Exercise 2 of Chapter 10:");
      displayList(myList);
   } // end answerExercise2InChapter10
